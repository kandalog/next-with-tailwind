...
const statsContent = {
  ...
  text: {
    ...
    description: "学習の目的や目標に合わせてあなただけの目標を設定します",
    ...
    <section className="pt-20 pb-10">
      <div className="container px-4 mx-auto">
        <div className="lg:flex justify-between items-center space-x-0">
          {/* 左 */}
          <div className="w-full lg:w-7/12 mb-20 lg:mb-0 max-md:overflow-hidden">
          ...
          <div className="w-full lg:w-5/12">
            <div
              className="bg-light py-10 px-7 lg:px-10
             !pr-28 md:!pr-3 lg:!pr-40 rounded-lg relative"
              data-aos="fade-left"
              data-aos-delay="100"
            >
              <Image
              ...
              >
                <span>もっとみる</span>
                <span
                  className="w-6 h-6 rounded-full bg-green text-white items-center justify-center
                inline-flex duration-300 transition-all ease-in-out group-hover:bg-[#006e54]"
                >
                  <BiChevronRight />
                </span>
              </Link>
